...
SUITES=(tests.test_approvals tests.test_render tests.test_vmctl tests.test_bridge_args tests.test_hook_paths tests.test_cloud_init tests.test_commands tests.test_bash_policy)
if [[ "${1:-}" != "--offline" ]]; then
